...
homekit_characteristic_t name = HOMEKIT_CHARACTERISTIC_(NAME, "LuxMotionContactRelay");
...
void sensor_callback_4(bool high, void *context) {
...
homekit_accessory_t *accessories[] = {
  ...
  HOMEKIT_ACCESSORY(
      ...
      .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            ...
            HOMEKIT_CHARACTERISTIC(NAME, "Sensor Suíte"),
            &manufacturer,
            &serial,
            &model,
            &revision,
  ...
  HOMEKIT_ACCESSORY(
      ...
      .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            HOMEKIT_CHARACTERISTIC(IDENTIFY, door_identify),
            HOMEKIT_CHARACTERISTIC(NAME, "Sensor Closet"),
            &manufacturer,
            &serial,
            &model,
            &revision,
...
void user_init(void) {
    ...
    if (toggle_create(SENSOR_PIN_4, sensor_callback_4, NULL)) {
